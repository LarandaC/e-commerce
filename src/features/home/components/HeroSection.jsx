...
import { CtaSecondaryButton } from "../../../components/ui/buttons/CtaSecondaryButton";
import {
  CONTAINER_BASE,
  HEADING,
  TEXT_BODY_MAX_WIDTH,
} from "../../../utils/classNames";
import { SocialMedia } from "../../../components/ui/display/SocialMedia";
      ...
      <div className={`${CONTAINER_BASE} py-10 relative z-10`}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mx-auto">
          ...
          <div className="space-y-8 text-center lg:text-left order-1 lg:order-1">
            {/* Badge */}
            <div className="inline-flex items-center justify-center lg:justify-start mt-16 sm:mt-0 gap-2 px-6 py-2 bg-primary rounded-full w-fit mx-auto lg:mx-0 fade-in">
            ...
            >
              <h1 className={HEADING}>
                Descubre tu
                <br />
                <span className="text-primary font-black">estilo único</span>
              </h1>
            ...
            {/* CTA */}
            <div
              className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4 fade-in-up"
